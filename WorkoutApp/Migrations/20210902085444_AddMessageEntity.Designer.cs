...
namespace WorkoutApp.Migrations
{
    ...
    [Migration("20210902085444_AddMessageEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkoutApp.Entities.FeedbackEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("WorkoutApp.Entities.MessageEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("WorkoutApp.Entities.MessageEntity", b =>
                {
                    b.HasOne("WorkoutApp.Entities.UserEntity", "SenderUser")
                        .WithMany("SentMessages")
                        .HasForeignKey("SenderUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WorkoutApp.Entities.UserEntity", "TriggeredUser")
                        .WithMany("ReceivedMessages")
                        .HasForeignKey("TriggeredUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("SenderUser");

                    b.Navigation("TriggeredUser");
                });
